...
Bvar.Wvar$ratio <- Bvar.Wvar$B.var/Bvar.Wvar$W.var
Bvar.Wvar$log.ratio <- log(Bvar.Wvar$B.var)/log(Bvar.Wvar$W.var)

Bvar.Wvar%>% 
  ggplot(aes(x = log.ratio, y = table.drift.results$intercept)) +
  geom_point() +
