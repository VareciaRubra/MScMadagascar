...
arquivo.bruto = "Data/Cheirogaleus_All.csv"
arquivo.saida = "Data/Cheirogaleus_Clean.csv"
...
raw.data %<>% 
  filter(Tombo != "ZMB_Mam_5511") %>% #comentario de pq foi removido
  filter(Tombo != "10956_B") %>%
  filter(Tombo != "109858_A") #%>%
