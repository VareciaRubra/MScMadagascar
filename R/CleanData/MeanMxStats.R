...
RS<- llply(cov.x= cov.mx[mask.n.size], RandomSkewers, num.vectors = 1000, repeat.vector = mx.rep[mask.n.size, 2] )
...
RS.compare <- RandomSkewers(cov.x = cov.mx[mask.n.size], repeat.vector = mx.rep[mask.n.size, 2] , num.vectors = 1000, parallel = TRUE)
coord